...
CREATE TABLE chatbots (
    ...
    bot_message_color VARCHAR(7) DEFAULT '#3b82f6',
    user_message_color VARCHAR(7) DEFAULT '#3b82f6',
    bot_message_text_color VARCHAR(7) DEFAULT '#ffffff',
    user_message_text_color VARCHAR(7) DEFAULT '#ffffff',
    chat_font_family VARCHAR(50) DEFAULT 'Inter, sans-serif',
    chat_header_color VARCHAR(7) DEFAULT '#3b82f6',
    chat_header_text_color VARCHAR(7) DEFAULT '#ffffff',
    chat_background_color VARCHAR(7) DEFAULT '#fff5e6',
