...
7. **Task-Specific Branching:** Every task must be implemented in its own branch to keep the main branch clean.
...
2. **Create and Switch to Task Branch:**
...
3.  **Execute Automated Tests with Proactive Debugging:**
    ...
    -   **Example Announcement:** "I will now run the automated test suite to verify the phase. **Command:** `make test-all`"
...
7.  **Attach Auditable Verification Report using Commit Message:**
    -   **Step 7.1: Draft Report:** Include the automated test command, the manual verification steps, and the user's confirmation in the commit message of the checkpoint commit or as a subsequent commit.
...
6. Implementation notes added to commit message
7. Changes merged to main and task branch deleted
