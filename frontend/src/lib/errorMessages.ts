...
const exactMap: Record<string, string> = {
    ...
    'cannot delete the last workspace in the organization': 'Organizasyondaki son çalışma alanı silinemez',
...
const includesMap: Array<{ includes: string; tr: string }> = [
    { includes: 'cannot demote the last owner', tr: 'Organizasyonun son sahibinin rolü değiştirilemez' },
    { includes: 'cannot promote yourself', tr: 'Kendi rolünüzü yükseltemezsiniz' },
    { includes: 'only owners can assign owner role', tr: 'Sahip rolünü yalnızca sahipler atayabilir' },
