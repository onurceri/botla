...
export default function ParameterBuilder({ value, onChange }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-4">
        {params.map((param) => (
          <div key={param.id} className="grid grid-cols-1 md:grid-cols-12 gap-4 items-start border p-4 rounded-lg bg-muted/20">
            ...
            <div className="md:col-span-2 space-y-2 flex flex-col justify-center h-full pt-6">
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor={`req-${param.id}`} className="text-xs cursor-pointer">Zorunlu</Label>
              </div>
            </div>
