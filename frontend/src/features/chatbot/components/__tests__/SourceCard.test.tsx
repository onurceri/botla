...
describe('SourceCard', () => {
  ...
  it('renders source card with correct source type icon for URL', () => {
    ...
    const { container } = render(
      <SourceCard 
        source={mockSource({ source_type: 'url', source_url: 'https://example.com', original_filename: undefined })} 
        userPlan="pro" 
        onDelete={onDelete} 
        onRefresh={onRefresh} 
      />,
  ...
  it('renders completed status badge correctly', () => {
    ...
    const onRefresh = vi.fn()
    const { container } = render(
      <SourceCard source={mockSource({ status: 'completed' })} userPlan="pro" onDelete={onDelete} onRefresh={onRefresh} />,
      { wrapper: createWrapper() }
    )
  ...
  it('renders processing status badge correctly', () => {
    ...
    const onRefresh = vi.fn()
    const { container } = render(
      <SourceCard source={mockSource({ status: 'processing' })} userPlan="pro" onDelete={onDelete} onRefresh={onRefresh} />,
      { wrapper: createWrapper() }
    )
  ...
  it('renders failed status badge correctly', () => {
    ...
    const onRefresh = vi.fn()
    const { container } = render(
      <SourceCard source={mockSource({ status: 'failed' })} userPlan="pro" onDelete={onDelete} onRefresh={onRefresh} />,
      { wrapper: createWrapper() }
    )
  ...
  it('renders queued status badge correctly', () => {
    ...
    const onRefresh = vi.fn()
    const { container } = render(
      <SourceCard source={mockSource({ status: 'queued' })} userPlan="pro" onDelete={onDelete} onRefresh={onRefresh} />,
      { wrapper: createWrapper() }
    )
  ...
  it('shows refresh button only for URL sources', () => {
    ...
    const { container: pdfContainer } = render(
      <SourceCard source={mockSource({ source_type: 'pdf' })} userPlan="pro" onDelete={onDelete} onRefresh={onRefresh} />,
      { wrapper: createWrapper() }
    )
    ...
    const { container: urlContainer } = render(
      <SourceCard source={mockSource({ source_type: 'url', source_url: 'https://example.com' })} userPlan="pro" onDelete={onDelete} onRefresh={onRefresh} />,
      { wrapper: createWrapper() }
    )
  ...
  it('displays chunk count correctly', () => {
    ...
    const onRefresh = vi.fn()
    const { container } = render(
      <SourceCard source={mockSource({ chunk_count: 42 })} userPlan="pro" onDelete={onDelete} onRefresh={onRefresh} />,
      { wrapper: createWrapper() }
    )
