...
export default function ActionForm({ action, onSave, onCancel, isSaving }: Props) {
  ...
  const [actionType, setActionType] = useState<'builtin' | 'http' | 'zapier'>(
            ...
            <div className="grid gap-4 pl-8">
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  placeholder="Örn: Sipariş Durumu Sorgula"
                />
                <p className="text-xs text-muted-foreground">
                  AI'ın bu aksiyonu ne zaman kullanacağını anlaması için açıklayıcı bir isim verin.
                </p>
              </div>
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  placeholder="Bu aksiyon ne işe yarar?"
                />
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="pl-8">
              <div className="mb-4 text-sm text-muted-foreground">
                AI'ın bu aksiyonu çalıştırırken kullanıcıdan hangi bilgileri alması gerektiğini
                tanımlayın.
              </div>
