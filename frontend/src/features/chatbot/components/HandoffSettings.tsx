            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription className="text-base mt-1">
                  Bot cevaplayamadığında veya kullanıcı istediğinde insan operatöre devir
                  süreçlerini yönetin.
                </CardDescription>
              </div>
            </div>
        ...
        <CardContent className="p-6">
          {!canUseHandoff && (
            <div className="mb-6 bg-amber-500/5 border border-amber-500/20 rounded-xl p-4 flex items-center gap-4">
              ...
              <div>
                <span className="font-semibold text-amber-900 dark:text-amber-500 block">
                  Enterprise Özelliği
                </span>
                <span className="text-muted-foreground text-sm">
                  İnsan desteği özelliğini kullanmak için planınızı yükseltin.
                </span>
              </div>
              <Button
                variant="outline"
                size="sm"
                className="ml-auto border-amber-500/20 hover:bg-amber-500/10 text-amber-600"
              >
                Yükselt
              </Button>
            </div>
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center border-2 border-dashed rounded-2xl bg-muted/10 space-y-4">
              ...
              <div className="max-w-md space-y-2">
                ...
                <p className="text-muted-foreground">
                  Şu anda kullanıcılar bir temsilciye bağlanma talebinde bulunamaz. Sadece bot
                  yanıtları aktiftir.
                </p>
              </div>
            </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="relative flex items-center gap-4 p-4 border-2 border-primary bg-primary/5 rounded-xl cursor-pointer shadow-sm">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-0.5">
                        Konuşma dökümünü e-posta ile gönder.
                      </p>
                    </div>
                  ...
                  <div className="flex items-center gap-4 p-4 border rounded-xl opacity-50 cursor-not-allowed bg-muted/20">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-0.5">
                        Intercom, Zendesk vb. entegrasyonlar.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Destek taleplerinin iletileceği adres ve format ayarları.
                  </p>
                </div>
                  ...
                  <div className="flex items-start gap-3 p-4 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-700 dark:text-amber-400">
                    ...
                    <div className="text-sm">
                      ...
                      <p className="mt-1 opacity-90">
                        İnsan desteği özelliğinin çalışması için geçerli bir e-posta adresi girmeniz
                        gerekmektedir. Aksi takdirde talepler iletilemez.
                      </p>
                    </div>
                  </div>
                )}
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Kullanıcı sohbet esnasında "İnsan Desteği" butonuna tıklar veya temsilciyle
                    görüşmek istediğini belirtir.
                  </p>
                </div>
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-sm font-medium text-foreground">
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Tüm konuşma geçmişi ve kullanıcı bilgileri, belirlediğiniz e-posta adresine
                    anında raporlanır.
                  </p>
                </div>
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Kullanıcıya talebinin alındığı ve en kısa sürede dönüş yapılacağı bilgisi
                    verilir.
                  </p>
                </div>
              </div>
