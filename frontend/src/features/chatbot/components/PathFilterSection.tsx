      ...
      >
        <div className="flex items-center gap-2.5">
          ...
          {totalFilters > 0 && (
            <Badge
              variant="secondary"
              className="text-[10px] px-1.5 py-0 h-4 font-medium bg-blue-100 text-blue-600 border-0"
            >
              {totalFilters} ayar
            </Badge>
          )}
          ...
          <div className="space-y-5">
            ...
            <div className="pt-4 border-t border-border/30 space-y-3">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed mb-3">
                Sadece belirtilen HTML elementlerinden metin çıkarılır. Menü, footer gibi gereksiz
                alanları hariç tutmak için kullanın.
              </p>
