...
describe('ChatbotDetailPage connect tab secret refresh', () => {
  it('enables secure embed and refreshes secret', async () => {
    ...
    const connectTrigger = await view.findByRole('link', { name: /Entegrasyon/ })
    ...
    const after = (await view.findByPlaceholderText('Gizli anahtar henüz oluşturulmadı') as HTMLInputElement).value
