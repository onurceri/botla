...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen flex bg-background relative overflow-hidden">
      ...
      <div className="absolute bottom-10 left-10 w-96 h-96 bg-accent/30 rounded-full blur-3xl animate-float" style={{ animationDelay: '-2s' }} />
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative z-10">
        ...
        <div className="max-w-lg">
          <h1 className="heading-lg text-foreground mb-6 animate-fade-up text-balance" style={{ animationDelay: '100ms' }}>
            Müşteri desteğinizi{' '}
            <span className="text-gradient">otomatize edin</span>
          </h1>
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-primary/10 
        ...
        {/* Footer */}
        <div className="text-sm text-muted-foreground animate-fade-up" style={{ animationDelay: '400ms' }}>
