      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative z-10">
        ...
        <div className="max-w-lg animate-fade-up" style={{ animationDelay: '100ms' }}>
          ...
          <h1 className="heading-xl text-foreground mb-6 text-balance">
            ...
            <span className="text-gradient">akıllı chatbotlar</span>{' '}
            oluşturun.
          </h1>
          <p className="body-lg mb-8">
            PDF, URL veya metin dosyalarınızı yükleyin, dakikalar içinde 
            sitenize entegre edin. 7/24 çalışan, yorulmayan ve sürekli 
            öğrenen bir asistan ile işinizi büyütün.
          </p>
        ...
        {/* Footer */}
        <div className="text-sm text-muted-foreground animate-fade-up" style={{ animationDelay: '200ms' }}>
